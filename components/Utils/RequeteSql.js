const requetes = {
    ...
    InsererContact : "INSERT INTO contact (ctt_id, ctt_photo, ctt_prenom, ctt_nom, ctt_prenom_usage, ctt_entreprise, ctt_fonction, ctt_anniversaire, ctt_notes, ctt_service, ctt_siteweb, ctt_twitter, ctt_linkedin, ctt_facebook, ctt_skype, ctt_etat, ctt_favoris, synchronise) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
    InsererTelephone : "INSERT INTO telephone (tel_numero, tel_code_pays, tel_libelle, ctt_id) VALUES (?,?,?,?)",
    InsererMail : "INSERT INTO mail ( ml_mail, ml_libelle, ctt_id) VALUES (?,?,?)",

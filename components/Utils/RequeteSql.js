const requetes = {
    ...
    GetContact: "SELECT ctt_id, ctt_photo, ctt_prenom, ctt_nom, ctt_prenom_usage, ctt_anniversaire, ctt_corbeille, ctt_entreprise, ctt_etat, ctt_facebook, ctt_favoris, ctt_fonction, ctt_linkedin, ctt_notes, ctt_service, ctt_siteweb, ctt_skype, ctt_twitter, ctt_etat, util_id, ctt_id_web FROM contact WHERE ctt_id = ?",
    ...
    InsererContact: "INSERT INTO contact (ctt_photo, ctt_prenom, ctt_nom, ctt_prenom_usage, ctt_entreprise, ctt_fonction, ctt_anniversaire, ctt_notes, ctt_service, ctt_siteweb, ctt_twitter, ctt_linkedin, ctt_facebook, ctt_skype, ctt_etat, ctt_favoris, util_id, ctt_id_web, est_insererdansweb, est_maj) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
